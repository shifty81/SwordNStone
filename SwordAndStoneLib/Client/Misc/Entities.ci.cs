...
#pragma warning disable CS0649 // Field is assigned through network processing or serialization
...
public class EntityDrawText
{
	...
	internal float dy;
	internal float dz;
#pragma warning disable CS0649 // Fields are assigned through entity processing or initialization
	internal float rotx;
	internal float roty;
	internal float rotz;
#pragma warning restore CS0649
